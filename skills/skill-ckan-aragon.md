---
name: ckan-aragon
description: "CLI para el portal de datos abiertos de Aragón (CKAN v3, ruta no estándar). Trigger: aragón, datos abiertos aragón, opendata aragon, datasets aragoneses."
license: MIT
metadata:
  author: comunidad OpenCode
  version: "1.0.0"
  api_base: "https://opendata.aragon.es"
  api_path: "/ckan/api/3/action"
  api_type: ckan
  base_template: skill-ckan-base
---

# SKILL: ckan-aragon — Portal de Datos Abiertos de Aragón (CKAN)
...
- **author**: comunidad OpenCode
- **api_base**: `https://opendata.aragon.es`
- **api_path**: `/ckan/api/3/action` (ruta no estándar)
- **api_type**: CKAN v3
- **base_template**: `skill-ckan-base`
...
- "aragón", "datos abiertos aragón", "opendata aragon"
- "datos del gobierno de aragón", "portal aragon datos abiertos"
- "datasets aragoneses", "organizaciones aragón"
- Cualquier referencia a `opendata.aragon.es`
...
**Atención**: Aragón usa una ruta no estándar (`/ckan/api/3/action` en lugar de `/api/3/action`).
...
api = 'https://opendata.aragon.es/ckan/api/3/action'
...
- **Ruta no estándar**: usa `/ckan/api/3/action` en lugar de `/api/3/action`
