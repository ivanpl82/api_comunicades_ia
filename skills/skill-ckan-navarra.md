---
name: ckan-navarra
description: "CLI para el portal de datos abiertos de Navarra (CKAN v3). Trigger: navarra, datos abiertos navarra, opendata navarra, datasets navarros."
license: MIT
metadata:
  author: comunidad OpenCode
  version: "1.0.0"
  api_base: "https://datos.navarra.es"
  api_path: "/api/3/action"
  api_type: ckan
  base_template: skill-ckan-base
---

# SKILL: ckan-navarra — Portal de Datos Abiertos de Navarra (CKAN)
...
- "navarra", "datos abiertos navarra", "opendata navarra"
- "portal de datos de navarra", "datasets navarros"
- "gobierno de navarra datos", "navarra datos públicos"
- Cualquier referencia a `datos.navarra.es`

## API Base

```
https://datos.navarra.es/api/3/action
```
...
api = 'https://datos.navarra.es/api/3/action'
