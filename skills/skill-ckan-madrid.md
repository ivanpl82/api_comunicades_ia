---
name: ckan-madrid
description: "CLI para el portal de datos abiertos de la Comunidad de Madrid (CKAN v3). Trigger: comunidad de madrid, datos abiertos madrid, opendata madrid, datasets madrileños."
license: MIT
metadata:
  author: comunidad OpenCode
  version: "1.0.0"
  api_base: "https://datos.comunidad.madrid"
  api_path: "/api/3/action"
  api_type: ckan
  base_template: skill-ckan-base
---

# SKILL: ckan-madrid — Portal de Datos Abiertos de la Comunidad de Madrid (CKAN)
...
- "comunidad de madrid", "datos abiertos madrid", "madrid opendata"
- "portal de datos de madrid", "datasets madrileños"
- "datos de la comunidad de madrid", "madrid datos abiertos"
- Cualquier referencia a `datos.comunidad.madrid`
...
api = 'https://datos.comunidad.madrid/api/3/action'
