---
name: ckan-valencia
description: "CLI para el portal de datos abiertos de la Comunidad Valenciana (CKAN v3). Trigger: comunidad valenciana, datos abiertos valencia, dades obertes, gva opendata."
license: MIT
metadata:
  author: comunidad OpenCode
  version: "1.0.0"
  api_base: "https://dadesobertes.gva.es"
  api_path: "/api/3/action"
  api_type: ckan
  base_template: skill-ckan-base
---

# SKILL: ckan-valencia — Portal de Datos Abiertos de la Comunidad Valenciana (CKAN)
...
- "comunidad valenciana", "valencia", "datos abiertos valencia"
- "dades obertes", "gva opendata", "portal gva datos"
- "datasets valencianos", "datos de la generalitat valenciana"
- Cualquier referencia a `dadesobertes.gva.es`

## API Base

```
https://dadesobertes.gva.es/api/3/action
```
...
api = 'https://dadesobertes.gva.es/api/3/action'
