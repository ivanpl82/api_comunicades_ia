---
name: ckan-castillalamancha
description: "CLI para el portal de datos abiertos de Castilla-La Mancha (CKAN v3). Trigger: castilla la mancha, datos abiertos castillalamancha, datos clm, datasets castillalamancha."
license: MIT
metadata:
  author: comunidad OpenCode
  version: "1.0.0"
  api_base: "https://datosabiertos.castillalamancha.es"
  api_path: "/api/3/action"
  api_type: ckan
  base_template: skill-ckan-base
---

# SKILL: ckan-castillalamancha — Portal de Datos Abiertos de Castilla-La Mancha (CKAN)
...
- "castilla la mancha", "datos abiertos castilla la mancha"
- "clm datos abiertos", "castillalamancha opendata"
- "datasets de castilla la mancha", "gobierno de clm datos"
- Cualquier referencia a `datosabiertos.castillalamancha.es`

## API Base

```
https://datosabiertos.castillalamancha.es/api/3/action
```

CKAN v3 pública — no requiere API key. Formato JSON en todas las respuestas.
Más de 200 datasets disponibles.
...
api = 'https://datosabiertos.castillalamancha.es/api/3/action'
